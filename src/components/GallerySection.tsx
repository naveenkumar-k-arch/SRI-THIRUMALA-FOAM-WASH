  ...
  const galleryItems: GalleryItem[] = [
    {
      ...
      title: 'Sri Thirumala Active High-Foam Transformation',
      vehicleName: 'SUV • Subaru Outback (TN 01 AB 1234)',
      sub: 'Thick active snow foam lifting gritty road film and restoring brilliant gloss at our Karpur workshop.',
      imageUrl: '/images/foam/car-after.jpg',
      tags: ['Real Workshop Result', 'Thick Snow Foam', 'Spotless Finish'],
      treatmentSteps: [
