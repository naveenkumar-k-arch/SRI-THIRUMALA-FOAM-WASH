...
export const AdminDashboardPage: React.FC<AdminDashboardPageProps> = ({
  ...
  const fetchLiveDatabaseData = async () => {
    ...
    try {
      ...
      // Fallback from Firestore if needed
      try {
  ...
  const handleMarkPaymentCollected = async (paymentId: string) => {
    ...
    showToast(`Payment settled to PAID!`);
  };
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center text-slate-800 font-sans">
        <div className="bg-white border border-slate-200 p-8 rounded-3xl shadow-xl flex items-center gap-4">
          <div className="w-8 h-8 border-3 border-orange-500 border-t-transparent rounded-full animate-spin" />
          <span className="font-bold text-slate-900 tracking-wide font-['Outfit']">Authenticating Super Admin Session...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col md:flex-row font-sans selection:bg-orange-500 selection:text-white relative">
      
      {/* ── Toast Notification Banner ───────────────────────────────────────── */}
      {toastMessage && (
        <div className="fixed bottom-6 right-6 z-50 bg-white border border-emerald-300 text-emerald-900 px-5 py-3.5 rounded-2xl shadow-xl flex items-center gap-3 animate-in fade-in slide-in-from-bottom-5">
      ...
      {/* ═════════════════════════════════════════════════════════════════════ */}
      {/* 🧭 LEFT SIDEBAR NAVIGATION (Bright, Clean Light Studio Style)        */}
      {/* ═════════════════════════════════════════════════════════════════════ */}
      <aside
        className={`fixed md:sticky top-0 z-40 h-screen w-72 bg-white border-r border-slate-200/90 shadow-sm flex flex-col justify-between transition-transform duration-300 ${
      ...
      >
        ...
        <div>
          <div className="p-5 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-red-600 to-orange-500 flex items-center justify-center shadow-md shadow-orange-500/20 text-white">
                <Shield className="w-5 h-5" />
              </div>
              <div>
                <div className="font-black text-sm text-slate-900 tracking-wider uppercase font-['Outfit']">
                  SRI THIRUMALA
                </div>
                <div className="flex items-center gap-1.5 mt-0.5">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                  <span className="text-[9px] font-bold uppercase tracking-wider text-orange-600 font-mono">
                    SUPER ADMIN CONSOLE
                  </span>
                </div>
              </div>
            ...
            <button
              ...
              className="md:hidden p-1.5 rounded-xl bg-slate-100 text-slate-500 hover:text-slate-900"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="p-3.5 space-y-1.5">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-3.5 py-3 rounded-2xl text-xs font-bold transition-all duration-200 cursor-pointer text-left ${
                activeTab === 'overview'
                  ? 'bg-gradient-to-r from-red-600 to-orange-600 text-white shadow-md shadow-orange-500/20'
                  : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100 font-medium'
              }`}
            >
              <div className={`p-1.5 rounded-xl ${activeTab === 'overview' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-600'}`}>
                <TrendingUp className="w-4 h-4 shrink-0" />
              </div>
              <div className="flex-1">
                <div>1. Revenue & Slots</div>
                <div className={`text-[10px] font-normal ${activeTab === 'overview' ? 'text-orange-100' : 'text-slate-400'}`}>
            ...
            >
              <div className={`p-1.5 rounded-xl ${activeTab === 'orders' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-600'}`}>
                <Car className="w-4 h-4 shrink-0" />
              </div>
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <span>2. Orders & Bookings</span>
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${activeTab === 'orders' ? 'bg-white/30 text-white' : 'bg-orange-100 text-orange-700'}`}>
                    {bookings.length}
                  </span>
                </div>
                <div className={`text-[10px] font-normal ${activeTab === 'orders' ? 'text-orange-100' : 'text-slate-400'}`}>
            ...
            >
              <div className={`p-1.5 rounded-xl ${activeTab === 'customers' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-600'}`}>
                <Users className="w-4 h-4 shrink-0" />
              </div>
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <span>3. All Customers</span>
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${activeTab === 'customers' ? 'bg-white/30 text-white' : 'bg-slate-200 text-slate-700'}`}>
                    {customers.length}
                  </span>
                </div>
                <div className={`text-[10px] font-normal ${activeTab === 'customers' ? 'text-orange-100' : 'text-slate-400'}`}>
            ...
            >
              <div className={`p-1.5 rounded-xl ${activeTab === 'slots' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-600'}`}>
                <Calendar className="w-4 h-4 shrink-0" />
              </div>
              <div className="flex-1">
                <div>4. Slot Management</div>
                <div className={`text-[10px] font-normal ${activeTab === 'slots' ? 'text-orange-100' : 'text-slate-400'}`}>
            ...
            >
              <div className={`p-1.5 rounded-xl ${activeTab === 'payments' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-600'}`}>
                <CreditCard className="w-4 h-4 shrink-0" />
              </div>
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <span>5. Payment Logs</span>
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${activeTab === 'payments' ? 'bg-white/30 text-white' : 'bg-slate-200 text-slate-700'}`}>
                    {payments.length}
                  </span>
                </div>
                <div className={`text-[10px] font-normal ${activeTab === 'payments' ? 'text-orange-100' : 'text-slate-400'}`}>
            ...
            >
              <div className={`p-1.5 rounded-xl ${activeTab === 'settings' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-600'}`}>
                <Settings className="w-4 h-4 shrink-0" />
              </div>
              <div className="flex-1">
                <div>6. Payment Settings</div>
                <div className={`text-[10px] font-normal ${activeTab === 'settings' ? 'text-orange-100' : 'text-slate-400'}`}>
        ...
        {/* Sidebar Footer Dock */}
        <div className="p-4 border-t border-slate-200/90 bg-slate-50/70 space-y-3">
          <div className="flex items-center gap-3 px-2 py-1.5 rounded-xl bg-white border border-slate-200 shadow-sm">
            <div className="w-7 h-7 rounded-lg bg-orange-100 text-orange-700 flex items-center justify-center font-bold text-xs">
              NA
            </div>
            <div className="flex-1 truncate">
              <div className="text-xs font-bold text-slate-900 truncate">Naveen Kumar K</div>
              <div className="text-[10px] text-slate-500 truncate">{user?.email || 'Admin'}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-100 text-xs font-bold text-slate-700 hover:text-slate-900 shadow-sm transition cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl border border-rose-200 bg-rose-50 text-xs font-bold text-rose-700 hover:bg-rose-100 transition cursor-pointer"
            >
      ...
      {/* ═════════════════════════════════════════════════════════════════ */}
      {/* 🖥️ RIGHT MAIN WORKSPACE CONTENT (Bright Light Studio Style)       */}
      {/* ═════════════════════════════════════════════════════════════════ */}
      <div className="flex-1 flex flex-col min-w-0 bg-slate-50">
        
        {/* Top bar header & active section breadcrumb */}
        <header className="sticky top-0 z-30 bg-white/90 border-b border-slate-200 px-4 sm:px-8 py-4 flex items-center justify-between backdrop-blur-md shadow-sm">
          <div className="flex items-center gap-3">
            <button
            ...
            <div>
              <h1 className="text-base sm:text-lg font-black text-slate-900 capitalize font-['Outfit'] flex items-center gap-2">
                <span>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 transition cursor-pointer flex items-center gap-1.5 text-xs font-bold border border-slate-200 shadow-sm"
            ...
            <span className="text-[11px] font-bold text-slate-700 bg-white px-3.5 py-1.5 rounded-xl border border-slate-200 shadow-sm hidden sm:inline-block font-mono">
        ...
        <main className="flex-1 p-4 sm:p-8 max-w-6xl w-full mx-auto space-y-6">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6 animate-in fade-in duration-200">
              ...
              {/* Clean Crisp KPI Stat Cards */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                
                {/* Today's Revenue */}
                <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-emerald-300 transition-all duration-200 relative overflow-hidden group">
                ...
                {/* Last 7 Days Revenue */}
                <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-amber-300 transition-all duration-200 relative overflow-hidden group">
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-[11px] text-amber-700 font-bold mt-2 flex items-center gap-1.5">
                ...
                <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-200 relative overflow-hidden group">
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-[11px] text-blue-700 font-bold mt-2 flex items-center gap-1.5">
                ...
                <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-sm hover:shadow-md hover:border-red-300 transition-all duration-200 relative overflow-hidden group">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs font-bold uppercase tracking-wider text-slate-500">Active In-Transit</span>
                    <div className="w-10 h-10 rounded-2xl bg-red-50 text-red-600 flex items-center justify-center border border-red-100 group-hover:scale-105 transition-transform">
                  ...
                  <div className="text-[11px] text-red-700 font-bold mt-2 flex items-center gap-1.5">
              ...
              <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  ...
                  <button
                    ...
                    className="text-xs text-orange-700 hover:text-orange-900 font-bold bg-orange-50 border border-orange-200 px-3.5 py-1.5 rounded-xl hover:bg-orange-100 transition cursor-pointer"
                  >
                    Manage Slot Matrix →
                  </button>
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between text-xs font-bold mb-2">
                          <span className="text-slate-800">Batch {index + 1}: {slot}</span>
                          <span
                        ...
                        <div className="flex items-center justify-between text-[11px] text-slate-500 mt-2.5 font-medium">
                          <span>Occupancy: <strong className="text-slate-900 font-mono">{isBlocked ? 'MAINTENANCE' : `${bookedInSlot} / ${capacity} Bays`}</strong></span>
                          <button
                            onClick={() => handleToggleSlotBlock(slot)}
                            className="text-orange-600 hover:text-orange-800 font-bold underline cursor-pointer text-[10px]"
                          >
              ...
              <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">Quick look at recent incoming wash orders</p>
                  </div>
                  <button
                    onClick={() => setActiveTab('orders')}
                    className="text-xs font-bold text-white bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 px-4 py-2 rounded-xl shadow-md transition cursor-pointer flex items-center gap-1.5"
                  >
                ...
                {bookings.length === 0 ? (
                  <div className="text-center py-10 text-slate-400 space-y-2 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                  ...
                  <div className="space-y-3">
                    {bookings.slice(0, 3).map((booking) => (
                      <div
                        key={booking.id}
                        className="p-4 rounded-2xl border border-slate-200/80 bg-slate-50/60 hover:bg-orange-50/30 transition flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-xl bg-orange-100 text-orange-700 flex items-center justify-center font-bold text-xs shrink-0 border border-orange-200">
                            {booking.vehicleType === 'bike' ? '🏍️' : booking.vehicleType === 'suv' ? '🚙' : '🚗'}
                          </div>
                          <div>
                            <div className="font-bold text-xs text-slate-900 flex items-center gap-2">
                              <span>{booking.customerName}</span>
                              <span className="font-mono text-[10px] text-orange-700 font-bold px-2 py-0.5 rounded bg-orange-50 border border-orange-200">
                                {booking.bookingRef}
                              </span>
                            </div>
                        ...
                        <div className="flex items-center justify-between sm:justify-end gap-4">
                          ...
                          <button
                            onClick={() => setActiveTab('orders')}
                            className="px-3 py-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-100 text-xs font-bold text-slate-700 transition cursor-pointer shadow-sm"
                          >
                            Manage
                          </button>
                        </div>
            ...
            <div className="space-y-6 animate-in fade-in duration-200">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="relative flex-1 max-w-md">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 text-xs text-slate-900 pl-10 pr-4 py-2.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:bg-white transition"
                    />
                  </div>
              ...
              <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  ...
                  <button
                    onClick={() => fetchLiveDatabaseData()}
                    className="text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-200 px-3 py-1.5 rounded-xl transition flex items-center gap-1.5 cursor-pointer shadow-sm"
                  >
                    <RefreshCw className={`w-3.5 h-3.5 ${dataLoading ? 'animate-spin' : ''}`} />
                ...
                {filteredOrders.length === 0 ? (
                  <div className="text-center py-16 text-slate-400 space-y-3 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                    ...
                    <table className="w-full text-left text-xs">
                      <thead>
                        <tr className="border-b border-slate-200 text-slate-500 uppercase tracking-wider font-bold bg-slate-50/50">
                          ...
                          <th className="py-3 px-4">Customer & Valet Address</th>
                        ...
                        {filteredOrders.map((booking) => (
                          <tr key={booking.id} className="hover:bg-orange-50/30 transition-colors">
                            <td className="py-4 px-4">
                              <div className="font-mono font-bold text-orange-700 text-xs">{booking.bookingRef}</div>
                            ...
                            <td className="py-4 px-4">
                              <select
                                ...
                                className="bg-white border border-slate-300 text-xs text-slate-800 rounded-xl px-3 py-1.5 font-bold shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500/30 cursor-pointer"
                              >
                            ...
                            <td className="py-4 px-4 text-right">
                              <button
                                ...
                                className="p-2 rounded-xl border border-slate-200 hover:border-orange-300 hover:bg-orange-50 text-slate-700 hover:text-orange-700 transition shadow-sm cursor-pointer inline-flex items-center gap-1 text-[11px] font-bold"
          ...
          {activeTab === 'customers' && (
            <div className="space-y-6 animate-in fade-in duration-200">
              ...
              <div className="bg-white border border-slate-200/90 rounded-3xl p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                ...
                {filteredCustomers.length === 0 ? (
                  <div className="text-center py-14 text-slate-400 space-y-3 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                    ...
                    <table className="w-full text-left text-xs">
                      <thead>
                        <tr className="border-b border-slate-200 text-slate-500 uppercase tracking-wider font-bold bg-slate-50/50">
                          ...
                          <th className="py-3 px-4">Washes Booked</th>
                      ...
                      <tbody className="divide-y divide-slate-100 font-medium">
                        {filteredCustomers.map((customer) => (
                          <tr key={customer.id} className="hover:bg-orange-50/30 transition-colors">
                            <td className="py-4 px-4">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center text-white font-bold text-xs shadow-sm">
                            ...
                            <td className="py-4 px-4">
                              <div className="text-slate-800 font-mono font-medium">{customer.phone}</div>
                            ...
                            <td className="py-4 px-4">
                              {customer.isVIP ? (
                                <span className="inline-flex items-center gap-1 text-[10px] font-bold px-2.5 py-1 rounded-full bg-amber-100 text-amber-800 border border-amber-200">
                                  <span>VIP Gold ⭐</span>
                                </span>
                              ) : (
                            ...
                            <td className="py-4 px-4 text-right">
                              <div className="flex items-center justify-end gap-2">
                                ...
                                <button
                                  ...
                                  className="p-2 rounded-xl bg-white border border-slate-200 text-slate-600 hover:text-orange-700 hover:border-orange-300 shadow-sm transition cursor-pointer"
            ...
            <div className="space-y-6 animate-in fade-in duration-200">
              ...
              <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  ...
                  <span className="text-xs text-orange-700 font-bold bg-orange-50 border border-orange-200 px-3 py-1 rounded-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 text-xs text-slate-900 px-3.5 py-2.5 rounded-xl font-mono focus:outline-none focus:ring-2 focus:ring-orange-500/20 shadow-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 border border-slate-200 text-xs text-slate-900 px-3.5 py-2.5 rounded-xl font-bold focus:outline-none focus:ring-2 focus:ring-orange-500/20 cursor-pointer shadow-sm"
                    >
                ...
                {STANDARD_TIME_SLOTS.map((slot, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-lg font-black text-slate-900 font-mono">{slot}</div>

                      {/* Capacity Bar */}
                      <div className="mt-4 space-y-1.5">
                        <div className="flex items-center justify-between text-xs font-bold">
                          <span className="text-slate-500">Occupancy</span>
                          <span className={isBlocked ? 'text-rose-700' : bookedCount >= capacity ? 'text-amber-700' : 'text-emerald-700'}>
                      ...
                      <div className="mt-4 pt-4 border-t border-slate-100 space-y-2">
                        ...
                        {slotBookings.length === 0 ? (
                          <div className="text-[11px] text-slate-400 italic">No vehicles in this batch window yet</div>
                        ) : (
                          slotBookings.map((b) => (
                            <div
                              key={b.id}
                            ...
                            >
                              <div>
                                ...
                                <span className="text-slate-500 font-mono ml-1.5">({b.vehicleModel})</span>
                              </div>
                              <span className="font-mono text-[10px] font-bold text-orange-700">{b.bookingRef}</span>
                            </div>
                          ))
                        )}
                      </div>
            ...
            <div className="space-y-6 animate-in fade-in duration-200">
              ...
              <div className="bg-white border border-slate-200/90 rounded-3xl p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <select
                    ...
                    className="bg-slate-50 border border-slate-200 text-xs text-slate-800 px-3.5 py-2 rounded-xl font-bold focus:outline-none focus:ring-2 focus:ring-orange-500/20 cursor-pointer"
                  >
              ...
              <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  ...
                  <span className="text-xs font-black text-emerald-800 font-mono bg-emerald-100 border border-emerald-200 px-3.5 py-1 rounded-full">
                ...
                {filteredPayments.length === 0 ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left text-xs">
                      <thead>
                        <tr className="border-b border-slate-200 text-slate-500 uppercase tracking-wider font-bold bg-slate-50/50">
                          <th className="py-3 px-4">Txn / Invoice Ref</th>
                      ...
                      <tbody className="divide-y divide-slate-100 font-medium">
                        {filteredPayments.map((payment) => (
                          <tr key={payment.id} className="hover:bg-orange-50/30 transition-colors">
                            <td className="py-4 px-4">
                              <div className="font-mono font-bold text-orange-700 text-xs">{payment.invoiceNumber}</div>
                              <div className="text-[10px] text-slate-400 font-mono">{payment.transactionRef} • {payment.date}</div>
                            </td>
                            <td className="py-4 px-4">
                              <div className="font-bold text-slate-900">{payment.customerName}</div>
                              <div className="text-[11px] text-slate-500 font-mono">{payment.customerPhone}</div>
                            </td>
                            <td className="py-4 px-4">
                              <div className="text-slate-800 font-semibold">{payment.serviceName}</div>
                              <div className="text-[10px] text-slate-500 font-mono">{payment.vehicleModel}</div>
                            </td>
                            <td className="py-4 px-4">
                              <span className="text-[10px] font-bold px-2 py-0.5 rounded-lg bg-slate-100 text-slate-700 border border-slate-200 uppercase">
                            ...
                            <td className="py-4 px-4 text-right">
                              <div className="flex items-center justify-end gap-2">
                                ...
                                <button
                                  ...
                                  className="p-2 rounded-xl bg-white border border-slate-200 text-slate-700 hover:text-orange-700 hover:border-orange-300 shadow-sm transition cursor-pointer"
              ...
              <form onSubmit={handleSavePaymentSettings} className="space-y-6">
                ...
                <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    ...
                    {/* UPI / QR Code Toggle */}
                    <label className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-200 cursor-pointer hover:border-orange-300 transition shadow-sm">
                      <div>
                        <div className="text-xs font-bold text-slate-900">UPI / QR Code Scan</div>
                    ...
                    <label className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-200 cursor-pointer hover:border-orange-300 transition shadow-sm">
                      <div>
                        <div className="text-xs font-bold text-slate-900">Cash on Delivery (Valet)</div>
                    ...
                    <label className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-200 cursor-pointer hover:border-orange-300 transition shadow-sm">
                      <div>
                        <div className="text-xs font-bold text-slate-900">Card on Delivery (mPOS)</div>
                    ...
                    <label className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-200 cursor-pointer hover:border-orange-300 transition shadow-sm">
                      <div>
                        <div className="text-xs font-bold text-slate-900">Net Banking / Direct IMPS</div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 text-xs text-slate-900 px-3.5 py-2.5 rounded-xl font-bold focus:outline-none focus:ring-2 focus:ring-orange-500/20 shadow-sm"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-7 shadow-sm space-y-4">
                  <div className="pb-4 border-b border-slate-100">
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">Control upfront advance payments and official GST invoice calculation</p>
                  </div>
                  ...
                  <div className="pt-2">
                    <label className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-200 cursor-pointer hover:border-orange-300 transition">
                      <div>
                        <div className="text-xs font-bold text-slate-900">Enable Itemized 18% GST Invoice Generation</div>
                        <div className="text-[11px] text-slate-500">Produces downloadable PDF tax invoices (CGST 9% + SGST 9%)</div>
                      </div>
                      <input
                        type="checkbox"
                ...
                <div className="flex items-center justify-end gap-3 pt-2">
                  <button
                    type="submit"
                    className="px-6 py-3 rounded-2xl bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 text-white font-black text-xs shadow-md shadow-orange-500/20 transition cursor-pointer flex items-center gap-2"
                  >
      ...
      {/* ═════════════════════════════════════════════════════════════════ */}
      {/* 📄 3D PRINTABLE INVOICE / RECEIPT MODAL (Clean Light Studio)      */}
      {/* ═════════════════════════════════════════════════════════════════ */}
      {selectedReceipt && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-5 overflow-y-auto animate-in fade-in duration-150">
          <div className="bg-white text-slate-900 w-full max-w-lg rounded-3xl shadow-2xl p-6 sm:p-8 space-y-6 relative border border-slate-200 my-auto font-sans">
            ...
            <div className="text-center pb-4 border-b border-slate-200">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-br from-red-600 to-orange-500 text-white mb-2 shadow-md">
                <Car className="w-6 h-6" />
              </div>
              <h2 className="text-lg font-black text-slate-900 tracking-wider uppercase font-['Outfit']">
                SRI THIRUMALA FOAM WASH
              </h2>
              <p className="text-xs text-slate-500 font-medium">Doorstep Valet & Auto Detailing Studio</p>
            ...
            <div className="flex items-center gap-3 pt-2 print:hidden">
              <button
                ...
                className="flex-1 py-3 rounded-2xl bg-slate-900 text-white font-bold text-xs hover:bg-slate-800 transition cursor-pointer flex items-center justify-center gap-2 shadow-md"
              >
      ...
      {/* ═════════════════════════════════════════════════════════════════ */}
      {/* 👤 CUSTOMER PROFILE & HISTORY DRAWER (Clean Light Studio)        */}
      {/* ═════════════════════════════════════════════════════════════════ */}
      {selectedCustomerHistory && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-5 overflow-y-auto animate-in fade-in duration-150">
          <div className="bg-white text-slate-900 border border-slate-200 w-full max-w-lg rounded-3xl shadow-2xl p-6 sm:p-7 space-y-5 relative my-auto">
            
            <button
              onClick={() => setSelectedCustomerHistory(null)}
              className="absolute top-5 right-5 p-2 rounded-full bg-slate-100 text-slate-500 hover:bg-slate-200 hover:text-slate-900 transition cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>

            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-red-600 to-orange-500 flex items-center justify-center text-white font-bold text-lg shadow-md shadow-orange-500/20">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-mono">{selectedCustomerHistory.phone}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 text-xs bg-slate-50 p-4 rounded-2xl border border-slate-200">
              <div>
                ...
                <strong className="text-slate-900 font-mono text-sm">{selectedCustomerHistory.totalBookings} Completed</strong>
              </div>
              <div>
                <span className="text-slate-500 uppercase block text-[10px]">Lifetime Spend:</span>
                <strong className="text-emerald-700 font-mono text-sm">₹{selectedCustomerHistory.totalSpent}</strong>
              </div>
              <div>
                <span className="text-slate-500 uppercase block text-[10px]">Preferred Vehicle:</span>
                <strong className="text-slate-800">{selectedCustomerHistory.preferredVehicle || 'Sedan'}</strong>
              </div>
              <div>
                <span className="text-slate-500 uppercase block text-[10px]">Registered On:</span>
                <strong className="text-slate-800">{selectedCustomerHistory.registeredDate}</strong>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="flex-1 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs transition text-center flex items-center justify-center gap-2 border border-slate-200 shadow-sm"
              >
                <Phone className="w-3.5 h-3.5 text-emerald-600" />
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs transition text-center flex items-center justify-center gap-2 shadow-md shadow-emerald-600/20"
              >
