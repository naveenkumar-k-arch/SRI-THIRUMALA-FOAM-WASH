...
export const HeroWashExperience: React.FC<HeroWashExperienceProps> = ({ onOpenBooking }) => {
  ...
  return (
    <section id="hero" className="relative min-h-svh flex flex-col justify-between pt-16 sm:pt-20 pb-3 sm:pb-6 overflow-hidden text-center bg-slate-950">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-20 sm:h-32 bg-gradient-to-t from-slate-950/70 to-transparent z-10"></div>
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 my-auto flex flex-col items-center pt-8 pb-4">
        ...
        {/* Headline */}
        <h1 className="text-2xl xs:text-3xl sm:text-5xl md:text-6xl font-black tracking-tight uppercase leading-tight sm:leading-tight font-['Outfit'] max-w-4xl drop-shadow-2xl text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 w-full">
          <div className="p-2 sm:p-2.5 rounded-xl bg-black/65 backdrop-blur-md border border-white/15 text-left flex items-center gap-2 shadow-lg">
            ...
            <div>
              ...
              <p className="text-[8px] sm:text-[9px] text-slate-300 leading-tight">Doorstep & return</p>
            </div>
          </div>
          ...
          <div className="p-2 sm:p-2.5 rounded-xl bg-black/65 backdrop-blur-md border border-white/15 text-left flex items-center gap-2 shadow-lg">
            ...
            <div>
              ...
              <p className="text-[8px] sm:text-[9px] text-slate-300 leading-tight">pH-neutral bath</p>
            </div>
          </div>
          ...
          <div className="p-2 sm:p-2.5 rounded-xl bg-black/65 backdrop-blur-md border border-white/15 text-left flex items-center gap-2 shadow-lg">
            ...
            <div>
              ...
              <p className="text-[8px] sm:text-[9px] text-slate-300 leading-tight">Soft water flush</p>
            </div>
          </div>
